...
it('shoud be able to search by id', function(){
    Template::factory()->count(5)->create(['name' => 'Joe Doe']);
    Template::factory()->count(5)->create(['name' => 'Jane Doe']);

    // Teste filtrando por id 
