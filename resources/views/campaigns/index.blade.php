<x-layouts.app>
    ...
    <x-card class="space-y-4">
        <div class="flex justify-between">
            ...
            <x-form :action="route('campaigns.index')" class="w-3/5 flex space-x-4 items-center" flat x-data x-ref="form">
                            ...
                            @else
                                <div>
                                    <x-form :action="route('campaigns.restore', $campaign)" patch flat onsubmit="return confirm('{{ __('Are you sure?') }}')">
                                        <x-button.secondary danger type="submit">Restore</x-button.secondary>
                                    </x-form>
                                </div>
